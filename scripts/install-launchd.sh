...
<dict>
  ...
  <dict>
    ...
    for var in ARGUS_HUB_ADDRESSES ARGUS_LIVE_LADDER ARGUS_LIVE_MAX_RESOLUTION ARGUS_LIVE_CONTENT_RESOLUTION ARGUS_LIVE_OBEY_BITRATE ARGUS_LIVE_1080P_BITRATE_KBPS ARGUS_LIVE_720P_BITRATE_KBPS ARGUS_LIVE_360P_BITRATE_KBPS ARGUS_LIVE_LOW_BITRATE_KBPS ARGUS_LIVE_KEEP_NEGOTIATED_SIZE ARGUS_LIVE_CBR ARGUS_LIVE_EXACT_FRAME ARGUS_LIVE_COPY ARGUS_AUDIO ARGUS_FFMPEG ARGUS_LIVE_AAC_ELD ARGUS_LIVE_AUDIO_SOURCE ARGUS_LIVE_MAIN_SOURCE ARGUS_LIVE_INTRA ARGUS_LIVE_PACKET_SIZE ARGUS_START_ACK_DELAY_MS ARGUS_HAP_BIND ARGUS_HAP_CONFIG_BUMP ARGUS_SRTP_LOOPBACK ARGUS_RTCP_MONITOR; do
