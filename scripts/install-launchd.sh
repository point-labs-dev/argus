...
<dict>
  ...
  <dict>
    ...
    for var in ARGUS_HUB_ADDRESSES ARGUS_LIVE_LADDER ARGUS_LIVE_OBEY_BITRATE ARGUS_LIVE_COPY ARGUS_AUDIO ARGUS_FFMPEG ARGUS_LIVE_AAC_ELD ARGUS_LIVE_MAIN_SOURCE ARGUS_LIVE_INTRA ARGUS_HAP_BIND; do
